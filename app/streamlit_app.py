...
# App Header
st.title("Simple Traffic Risk Prediction App")
st.write("Enter the parameters and predict the traffic risk level.")
...
# Function to Collect User Inputs and Predict
